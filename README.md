...
| 1    | Create a New Branch                         | https://github.com/Nohalyan/ppchem/tree/new-branch-newbranche_in_ppchem     |
| 1    | Create a conda environment                  | https://github.com/Nohalyan/ppchem/blob/new-branch-newbranche_in_ppchem/env.yml      |
| 1    | Fork a Repo                                 | https://github.com/Nohalyan/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/Nohalyan/ppchem/pull/1 |
